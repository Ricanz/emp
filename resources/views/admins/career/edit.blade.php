                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" value="{{$data->id}}" name="career_id">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" name="location">
                                                ...
                                                @foreach($locations as $location)
                                                    <option value="{{$location->id}}" {{$data->location == $location->id ? 'selected' : ''}}>{{$location->location}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="end_date" value="{{date('Y-m-d' , strtotime($data->end_date))}}">
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group" style="display: flex">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="status" id="status1" value="approved" {{$data->status == 'approved' ? 'checked' : ''}} >
                                            ...
                                            <div class="form-check ms-4">
                                                <input class="form-check-input" type="radio" name="status" id="status3" value="deleted" {{$data->status == 'deleted' ? 'checked' : ''}}>
