<ul class="nav flex-column bg-white border-radius-lg p-3">
    <li class="nav-item {{$page == 'profile' ? 'sub-menu-active' : ''}}">
    ...
    <li class="nav-item pt-2 {{$page == 'password' ? 'sub-menu-active' : ''}}">
    ...
    <li class="nav-item pt-2 {{$page == 'absences' ? 'sub-menu-active' : ''}}">
      <a class="nav-link text-body" data-scroll="" href="absences">
        <div class="icon me-2">
    ...
    <li class="nav-item pt-2 {{$page == 'tasks' ? 'sub-menu-active' : ''}}">
      <a class="nav-link text-body" data-scroll="" href="tasks">
        <div class="icon me-2">
          <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>switches</title>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <li class="nav-item pt-2 {{$page == 'daily-reports' ? 'sub-menu-active' : ''}}">
      <a class="nav-link text-body" data-scroll="" href="daily-reports">
        <div class="icon me-2">
          <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>switches</title>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <li class="nav-item pt-2 {{$page == 'weekly-reports' ? 'sub-menu-active' : ''}}">
      <a class="nav-link text-body" data-scroll="" href="weekly-reports">
        <div class="icon me-2">
          <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>switches</title>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="text-sm">Laporan Mingguan</span>
      </a>
    </li>
    <li class="nav-item pt-2 {{$page == 'monthly-reports' ? 'sub-menu-active' : ''}}">
      <a class="nav-link text-body" data-scroll="" href="monthly-reports">
        <div class="icon me-2">
          <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>switches</title>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="text-sm">Laporan Bulanan</span>
      </a>
    </li>
    <li class="nav-item pt-2 {{$page == 'final-reports' ? 'sub-menu-active' : ''}}">
      <a class="nav-link text-body" data-scroll="" href="final-reports">
        <div class="icon me-2">
          <svg class="text-dark mb-1" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title>switches</title>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="text-sm">Laporan Akhir</span>
      </a>
    </li>
